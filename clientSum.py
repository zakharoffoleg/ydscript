...
clientList = {
    ...
    "ВТБ Арена Парк": "ВТБ", "ЕОН": "ЕОН", "ЖК Полет Тасп Технолоджи": "ТАСП", "Ленстройтрест": "ЛЕНСТР",
    "ЛСР Комфорт": "ЛСР_К", "ЛСР Премиум": "ЛСР_П", "М16": "М16", "Мастер на Серебристом": "МАСТЕР_Д",
    "Метрика": "МЕТРИКА",
    "Мир Квартир": "МИР_КВАРТИР", "ПАН": "ПАН_", "Патриот Нева": "ПАТРИОТ", "Петрострой": "ПЕТРОСТРОЙ", "ПСК": "ПСК",
    "РБиАй": "RBI",
    "РГ Девелопмент": "РГ_ДЕВЕЛОПМЕНТ",
    "Рождественно Мир Митино": "РОЖДЕСТВЕНО", "Северный город": "СЕВЕРН",

    '''"Росстрой Инвест Петр Великий": "РОССТР", '''
    "РосСтройИнвест": "РОССТР",

    "Тренд Районы": "РАЙОНЫ",
    "Хочу Квартиру 3000": "ХОЧУ", "Эталон Серебряный фонтан": "ЭТАЛОН_ИНВЕСТ_ФОНТАН",


    # Спецпроекты
    '''"Альянс Добрыня-2": "АЛЬЯНС_ДОБРЫНЯ",'''
    "Альянс Добрыня": "АЛЬЯНС_ДОБРЫНЯ",

    "АСД Маленькая Швейцария": "ШВЕЙЦАРИЯ",
    "АСД (Маленькая Швейцария)": "ШВЕЙЦАРИЯ",
    "Афи Сильвер": "AFI", "Афи Силвер": "AFI",
    "Балтийская Жемчужина": "БАЛТИЙСКАЯ", "БФА Огни Залива": "БФА",

    '''"Вита Федоровское": "ВИТА_Ф",'''
    "Вита Фёдоровское": "ВИТА_Ф",
    ...
    "Монолит Вингс": "МОНОЛИТ", "Мир Квартир Монополист": "МОНОПОЛИСТ", "Нордэст Шуваловский": "НОРДЭСТ",
    "Ойкумена": "ОЙКУМЕНА", "Отделстрой Оккервиль": "ОТДЕЛСТРОЙ_ОККЕР", "Отделстрой Лесснер": "ОТДЕЛСТРОЙ_ЛЕСС",

    '''"Полис Групп Комендантский": "ПОЛИС_ГРУПП_КОМЕНДАНТСКИЙ", '''
    "Полис Групп (Комендантский)": "ПОЛИС_ГРУПП_К",

    "Романтика ЖК Ромашки": "РОМАНТИКА", "Самолет": "САМОЛЕТ", "Севен Санс": "SEVEN_SUNS",
