...
clientList = {
    ...
    "Рождественно Мир Митино": "РОЖДЕСТВЕНО", "Росстрой Инвест Петр Великий": "РОССТР", "Тренд Районы": "РАЙОНЫ",
    "Хочу Квартиру 3000": "ХОЧУ", "Эталон Серебряный фонтан": "ЭТАЛОН_ИНВЕСТ_ФОНТАН", "Северный город": "СЕВЕРН",
    "ПСК": "ПСК",
